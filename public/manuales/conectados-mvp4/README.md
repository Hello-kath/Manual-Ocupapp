...
### Votaciones (10 imágenes)

50. `votaciones-vista-general.png`
51. `votaciones-boton-crear.png`
52. `votaciones-formulario-creacion.png`
53. `votaciones-toggle-filtros.png`
54. `votaciones-checkbox-anonima.png`
55. `votaciones-tabla-columnas.png`
56. `votaciones-acciones-estado.png`
57. `votaciones-modal-publicacion.png`
58. `votaciones-busqueda-avanzada-popover.png`
59. `votaciones-selector-columnas-popover.png`

### Constancias de Utilidades (6 imágenes)

44. `constancias-historial-vista-general.png`
45. `constancias-busqueda-avanzada-popover.png`
46. `constancias-selector-columnas-popover.png`
47. `constancias-modal-detalle.png`
48. `constancias-seleccion-registros.png`
49. `constancias-exportacion-proceso.png`
