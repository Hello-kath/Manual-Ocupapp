...
## MÓDULO VII: HISTORIAL DE CONSTANCIAS DE UTILIDADES

### Imagen 44: `constancias-historial-vista-general.png`

**¿Qué capturar?**

- Vista general del módulo de Historial de Constancias de Utilidades.
- Título "Historial de constancias" visible.
- Tabla con columnas principales (Código colaborador, Nombre colaborador, Período, Fecha de carga, Fecha y hora de visualización, Estado, Acciones).
- URL visible: `/app/gestion/constancias/history`.

**¿Cómo obtenerla?**

1. Navegar a la URL del módulo.
2. Capturar la pantalla completa.

**Elementos importantes:**

- Interfaz limpia y clara.
- Tabla con al menos algunos registros.
- Título del módulo claramente visible.

---

### Imagen 45: `constancias-busqueda-avanzada-popover.png`

**¿Qué capturar?**

- Popover de búsqueda avanzada abierto.
- Campos de filtro visibles: Input de colaborador, Select de Período, Datepickers de Fecha de carga y Fecha de visualización.
- Botón "Filtrar" visible.
- Icono de búsqueda avanzada (`pi-sliders-h` o similar) que abre el popover.

**¿Cómo obtenerla?**

1. Hacer clic en el icono de búsqueda avanzada.
2. Capturar el popover abierto.

**Elementos importantes:**

- Todos los campos de filtro deben ser legibles.
- El popover debe estar claramente superpuesto a la vista principal.

---

### Imagen 46: `constancias-selector-columnas-popover.png`

**¿Qué capturar?**

- Popover del selector de columnas abierto.
- Checkboxes para seleccionar/deseleccionar columnas (ej. Período, Fecha carga, Fecha hora visualización).
- Icono de filtro (`pi-filter` o similar) que abre el popover.

**¿Cómo obtenerla?**

1. Hacer clic en el icono del selector de columnas.
2. Capturar el popover abierto.

**Elementos importantes:**

- Los checkboxes y nombres de columnas deben ser legibles.

---

### Imagen 47: `constancias-modal-detalle.png`

**¿Qué capturar?**

- Modal de detalle de una constancia abierto.
- Información completa de la constancia (Código, Colaborador, Período, Monto, Fecha de generación, Fecha de visualización, Estado).
- Título del modal "Detalle de Constancia" visible.
- Botón "Cerrar" visible.

**¿Cómo obtenerla?**

1. Hacer clic en el botón de ojo (`pi-eye`) de una fila de la tabla.
2. Capturar el modal de detalle.

---

### Imagen 48: `constancias-seleccion-registros.png`

**¿Qué capturar?**

- Tabla con al menos uno o varios registros seleccionados mediante checkboxes.
- El botón "Exportar datos" debe estar habilitado y visible.
- Los checkboxes seleccionados deben ser claramente visibles.

**¿Cómo obtenerla?**

1. Seleccionar uno o más checkboxes en la tabla.
2. Capturar la tabla con la selección y el botón de exportar habilitado.

---

### Imagen 49: `constancias-exportacion-proceso.png`

**¿Qué capturar?**

- El proceso de descarga del archivo Excel.
- Puede ser una notificación de descarga del navegador (barra inferior) o un mensaje de éxito del sistema.
- El nombre del archivo descargado debe ser `reporte_constancias.xlsx`.

**¿Cómo obtenerla?**

1. Después de hacer clic en "Exportar datos" con registros seleccionados.
2. Capturar la confirmación de descarga.
...
- **Módulo VII (Constancias de Utilidades):** 6 imágenes (44-49)
- **Módulo VIII (Votaciones):** 10 imágenes (50-59)
...
**Justificaciones:** 12. `justificaciones-bandeja-pendientes.png` 13. `justificaciones-detalle-completo.png` 14. `justificaciones-documento-sustento.png` 15. `justificaciones-aprobar-normal.png` 16. `justificaciones-modificar-fechas.png` 17. `justificaciones-aprobado-parcial.png` 18. `justificaciones-rechazar-sin-comentario.png` 19. `justificaciones-rechazo-con-comentario.png` 20. `justificaciones-notificacion-enviada.png`

**Certificados:** 21. `certificados-acceso-admin.png` 22. `certificados-historial-solicitudes.png` 23. `certificados-detalle-solicitud.png` 24. `certificados-filtrar-por-estado.png` 25. `certificados-notificacion-generado.png` 26. `certificados-exportar-reporte.png`

**Utilidades:** 27. `utilidades-acceso-analista.png` 28. `utilidades-lista-solicitudes.png` 29. `utilidades-carga-masiva-inicio.png` 30. `utilidades-seleccionar-zip.png` 31. `utilidades-carga-progreso.png` 32. `utilidades-carga-exitosa.png` 33. `utilidades-certificados-asociados.png` 34. `utilidades-configurar-fecha-abono.png` 35. `utilidades-fecha-abono-aplicada.png` 36. `utilidades-filtrar-estado.png` 37. `utilidades-filtrar-grupo-pago.png` 38. `utilidades-exportar-reporte-pagos.png` 39. `utilidades-reporte-excel-abierto.png` 40. `utilidades-historial-cargas.png`

**Notificaciones:** 41. `notificacion-push-aprobador.png` 42. `notificacion-colaborador-aprobado.png` 43. `notificacion-colaborador-rechazado.png`

**Constancias de Utilidades:** 44. `constancias-historial-vista-general.png` 45. `constancias-busqueda-avanzada-popover.png` 46. `constancias-selector-columnas-popover.png` 47. `constancias-modal-detalle.png` 48. `constancias-seleccion-registros.png` 49. `constancias-exportacion-proceso.png`
